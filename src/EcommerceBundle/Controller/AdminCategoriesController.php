...
class AdminCategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('EcommerceBundle:Administration:adminCategories/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('EcommerceBundle:Administration:adminCategories/new.html.twig', array(
            'category' => $category,
    ...
    public function showAction(Categories $category)
    {
        ...
        return $this->render('EcommerceBundle:Administration:adminCategories/show.html.twig', array(
            'category' => $category,
    ...
    public function editAction(Request $request, Categories $category)
    {
        ...
        return $this->render('EcommerceBundle:Administration:adminCategories/edit.html.twig', array(
            'category' => $category,
